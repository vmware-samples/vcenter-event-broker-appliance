...
{%- endfor -%}
{%- for toc in site.data['default'].toc -%}
  {%- for items in toc.subfolderitems -%}
  {%- if items.external_url -%}
  { 
   "title": {{ toc.title | normalize_whitespace | jsonify }}, 
   "text": {{ items.page | normalize_whitespace | jsonify }}, 
   "tags": "",
   "url": {{ items.external_url | jsonify }}
